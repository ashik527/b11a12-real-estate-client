...
const Footer = () => {
  return (
    <footer className="bg-green-200 border-t border-gray-100 px-6 py-12">
      <div className="max-w-7xl mx-auto grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-800">
              <span className="text-primary">Real Estate</span> Pro
            </span>
          </div>
          <p className="text-gray-500 text-sm leading-relaxed">
            Your trusted platform to explore, list, and review real estate properties worldwide.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/properties" className="text-gray-500 hover:text-primary transition-colors">Properties</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="text-gray-500 hover:text-primary transition-colors">Terms of Use</a></li>
